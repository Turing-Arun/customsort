...
/**
 * This controller class handles HTTP requests related to student operations.
 * It provides an endpoint to sort a list of students based on various parameters.
 * 
 ...
 * 
 * The controller also handles exceptions for invalid sort parameters.
 * 
 * Dependencies:
 * - StudentService: A service class that provides sorting functionalities.
 * 
 * Endpoints:
 * - POST /students/sort: Sorts the list of students based on the given sort parameter.
 * 
 * Exception Handling:
 * - IllegalArgumentException: Returns a bad request status code with an error message if the sort parameter is invalid.
 */
@RestController
...
public class StudentController {
    ...
    @PostMapping("/sort")
    public List<Student> sortStudents(@Valid @RequestBody List<Student> students, @Valid @RequestParam String sortBy) throws IllegalArgumentException
    {
