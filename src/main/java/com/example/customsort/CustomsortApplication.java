...
/**
 * The entry point of the Customsort Spring Boot application.
 * This class contains the main method which starts the application.
 * 
 * <p>
 * The {@code @SpringBootApplication} annotation indicates a configuration class
 * that declares one or more {@code @Bean} methods and also triggers auto-configuration
 * and component scanning. It's a convenience annotation that combines 
